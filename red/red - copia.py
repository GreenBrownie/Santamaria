...
# dataloaders para entrenamiento y validación Random state para que siempre sea la misma distribución LO VAMOS A ELIMINAR
...
class RedNeuronal(nn.Module):
    def __init__(self, entrada, oculta_1=2, oculta_2=1, salida=3):
        #Llamada al constructor del padre nn.Module
        super().__init__()

        #Capas tipo cFull connected 

        self.fc1 = nn.Linear(entrada, salida) # features convertidos en neuronas entrada x oculta_1
        self.relu1 = nn.ReLU()
